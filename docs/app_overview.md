# Kwarta - Application Overview

A comprehensive Flutter multi-platform personal finance application supporting Android, iOS, macOS, Linux, Windows, and Web.
...
- **Dev URL**: `http://127.0.0.1:8091`
- **Staging**: `https://staging.imbak.hznsystems.com`
- **Production**: `https://imbak.hznsystems.com`
